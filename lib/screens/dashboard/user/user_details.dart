...
class _UserDetailModalState extends State<UserDetailModal> {
  ...
  void initState() {
    ...
    if (widget.user != null) {
      ...
      firstNameController.text = widget.user!.email ?? '';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  apiController.updateUser({"UserId":widget.user?.userId,"Password":passwordController.text,"UserName":userNameController.text,"Department":selectedDepartment!.name});
